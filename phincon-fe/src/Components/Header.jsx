    ...
    <nav className="mx-4 border-b-2 p-3 flex items-center text-yellow-400">
      ...
      <div className="mr-10 max-w-sm rounded overflow-hidden mx-auto">
        <form className="w-full max-w-sm flex">
          ...
          <Link to={`/pokemon/${search.toLowerCase()}`}>
            <button className="flex-shrink-0 bg-green-400 border-green-400 text-sm border-4 text-white py-1 px-2 rounded hover:bg-yellow-400 transition duration-500 hover:border-yellow-400" type="submit">
              Search
            </button>
          </Link>
        </form>
